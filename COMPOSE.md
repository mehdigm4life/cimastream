...
The current design of Cima Stream loosely uses the MVVM architecture.
...
This is part of the effort to make Cima Stream cross platform, as it allows us to decouple UI and logic.
