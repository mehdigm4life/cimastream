...
@RequiresOptIn(
    message = "This API is only available on prerelease builds. " +
              "Using it will cause CimaStream stable to crash.",
        ...
        try {
            ...
            val vToken =
                app.get(
                    ...
                    .substringBefore("/")
            val recapToken =
                app.get("https://www.google.com/recaptcha/api2/anchor?ar=1&hl=en&size=invisible&cb=cima4&k=$key&co=$domain&v=$vToken")
                    .document
    ...
    companion object {
        ...
        fun fromOld(value: Int?): Score? {
            ...
            if (value < 0 || value > 10000) {
                com.mehdigm.api.Log.w(TAG, "old: $value ∉ [0, 10000]")
                return null
            }
        ...
        fun from(value: Int?, maxScore: Int): Score? {
            ...
            if (value < 0 || value > maxScore) {
                com.mehdigm.api.Log.w(TAG, "fromInt: $value ∉ [0, $maxScore]")
                return null
            }
        ...
        fun from(value: Double?, maxScore: Int): Score? {
            ...
            if (value < 0.0 || value > maxScore) {
                com.mehdigm.api.Log.w(TAG, "fromDouble: $value ∉ [0.0, $maxScore]")
                return null
            }
        ...
        fun from(value: Float?, maxScore: Int): Score? {
            ...
            if (value < 0.0 || value > maxScore) {
                com.mehdigm.api.Log.w(TAG, "fromFloat: $value ∉ [0.0f, $maxScore]")
                return null
            }
