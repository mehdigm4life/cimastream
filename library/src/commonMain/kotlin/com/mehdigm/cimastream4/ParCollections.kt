...
@Deprecated(
    ...
    replaceWith = ReplaceWith("amap(f)", "com.mehdigm.cimastream4.amap"),
...
@Deprecated(
    "This blocks with runBlocking, and should not be used inside a suspended context",
    replaceWith = ReplaceWith("amapIndexed(f)", "com.mehdigm.cimastream4.amapIndexed"),
    level = DeprecationLevel.ERROR
)
@Throws(CancellationException::class)
...
@Deprecated(
    "This blocks with runBlocking, and should not be used inside a suspended context",
    replaceWith = ReplaceWith("runAllAsync(transforms)", "com.mehdigm.cimastream4.runAllAsync"),
    level = DeprecationLevel.ERROR
)
@Throws(CancellationException::class)
fun <R> argamap(
