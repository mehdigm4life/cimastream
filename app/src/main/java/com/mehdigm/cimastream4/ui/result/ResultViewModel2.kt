...
import com.mehdigm.cimastream4.APIHolder.apis
import com.mehdigm.cimastream4.APIHolder.getApiFromNameNull
import com.mehdigm.cimastream4.APIHolder.unixTime
import com.mehdigm.cimastream4.APIHolder.unixTimeMS
import com.mehdigm.cimastream4.ActorData
import com.mehdigm.cimastream4.AnimeLoadResponse
import com.mehdigm.cimastream4.CimaStreamApp.Companion.context
import com.mehdigm.cimastream4.CimaStreamApp.Companion.setKey
import com.mehdigm.cimastream4.CommonActivity.activity
import com.mehdigm.cimastream4.CommonActivity.getCastSession
import com.mehdigm.cimastream4.CommonActivity.showToast
import com.mehdigm.cimastream4.DubStatus
import com.mehdigm.cimastream4.EpisodeResponse
import com.mehdigm.cimastream4.IDownloadableMinimum
import com.mehdigm.cimastream4.LiveStreamLoadResponse
import com.mehdigm.cimastream4.LoadResponse
import com.mehdigm.cimastream4.LoadResponse.Companion.addTrailer
import com.mehdigm.cimastream4.LoadResponse.Companion.getAniListId
import com.mehdigm.cimastream4.LoadResponse.Companion.getKitsuId
import com.mehdigm.cimastream4.LoadResponse.Companion.getMalId
import com.mehdigm.cimastream4.LoadResponse.Companion.isMovie
import com.mehdigm.cimastream4.LoadResponse.Companion.readIdFromString
import com.mehdigm.cimastream4.MainActivity
import com.mehdigm.cimastream4.MovieLoadResponse
import com.mehdigm.cimastream4.ProviderType
import com.mehdigm.cimastream4.R
import com.mehdigm.cimastream4.Score
import com.mehdigm.cimastream4.SearchResponse
import com.mehdigm.cimastream4.SeasonData
import com.mehdigm.cimastream4.ShowStatus
import com.mehdigm.cimastream4.SimklSyncServices
import com.mehdigm.cimastream4.SubtitleFile
import com.mehdigm.cimastream4.TorrentLoadResponse
import com.mehdigm.cimastream4.TrackerType
import com.mehdigm.cimastream4.TrailerData
import com.mehdigm.cimastream4.TvSeriesLoadResponse
import com.mehdigm.cimastream4.TvType
import com.mehdigm.cimastream4.VPNStatus
import com.mehdigm.cimastream4.actions.AlwaysAskAction
import com.mehdigm.cimastream4.actions.VideoClickActionHolder
import com.mehdigm.cimastream4.amap
import com.mehdigm.cimastream4.isEpisodeBased
import com.mehdigm.cimastream4.isLiveStream
import com.mehdigm.cimastream4.metaproviders.SyncRedirector
import com.mehdigm.cimastream4.mvvm.Resource
import com.mehdigm.cimastream4.mvvm.debugAssert
...
import com.mehdigm.cimastream4.mvvm.safeApiCall
import com.mehdigm.cimastream4.runAllAsync
import com.mehdigm.cimastream4.sortUrls
import com.mehdigm.cimastream4.syncproviders.AccountManager
import com.mehdigm.cimastream4.syncproviders.AccountManager.Companion.secondsToReadable
import com.mehdigm.cimastream4.syncproviders.SyncAPI
import com.mehdigm.cimastream4.syncproviders.providers.Kitsu
import com.mehdigm.cimastream4.ui.APIRepository
import com.mehdigm.cimastream4.ui.WatchType
import com.mehdigm.cimastream4.ui.player.GeneratorPlayer
import com.mehdigm.cimastream4.ui.player.LOADTYPE_ALL
import com.mehdigm.cimastream4.ui.player.LOADTYPE_CHROMECAST
import com.mehdigm.cimastream4.ui.player.LOADTYPE_INAPP
import com.mehdigm.cimastream4.ui.player.LOADTYPE_INAPP_DOWNLOAD
import com.mehdigm.cimastream4.ui.player.RepoLinkGenerator
import com.mehdigm.cimastream4.ui.player.SubtitleData
import com.mehdigm.cimastream4.ui.result.EpisodeAdapter.Companion.getPlayerAction
import com.mehdigm.cimastream4.utils.AppContextUtils.getNameFull
import com.mehdigm.cimastream4.utils.AppContextUtils.isConnectedToChromecast
import com.mehdigm.cimastream4.utils.AppContextUtils.setDefaultFocus
import com.mehdigm.cimastream4.utils.AppContextUtils.sortSubs
import com.mehdigm.cimastream4.utils.AppUtils.toJson
import com.mehdigm.cimastream4.utils.CastHelper.startCast
import com.mehdigm.cimastream4.utils.Coroutines.ioSafe
import com.mehdigm.cimastream4.utils.Coroutines.ioWork
import com.mehdigm.cimastream4.utils.Coroutines.ioWorkSafe
import com.mehdigm.cimastream4.utils.Coroutines.main
import com.mehdigm.cimastream4.utils.DOWNLOAD_HEADER_CACHE
import com.mehdigm.cimastream4.utils.DataStore
import com.mehdigm.cimastream4.utils.DataStore.editor
import com.mehdigm.cimastream4.utils.DataStore.getFolderName
import com.mehdigm.cimastream4.utils.DataStore.setKey
import com.mehdigm.cimastream4.utils.DataStoreHelper
import com.mehdigm.cimastream4.utils.DataStoreHelper.currentAccount
import com.mehdigm.cimastream4.utils.DataStoreHelper.deleteBookmarkedData
import com.mehdigm.cimastream4.utils.DataStoreHelper.getAllBookmarkedData
import com.mehdigm.cimastream4.utils.DataStoreHelper.getAllFavorites
import com.mehdigm.cimastream4.utils.DataStoreHelper.getAllSubscriptions
import com.mehdigm.cimastream4.utils.DataStoreHelper.getBookmarkedData
import com.mehdigm.cimastream4.utils.DataStoreHelper.getDub
import com.mehdigm.cimastream4.utils.DataStoreHelper.getFavoritesData
import com.mehdigm.cimastream4.utils.DataStoreHelper.getLastWatched
import com.mehdigm.cimastream4.utils.DataStoreHelper.getResultEpisode
import com.mehdigm.cimastream4.utils.DataStoreHelper.getResultSeason
import com.mehdigm.cimastream4.utils.DataStoreHelper.getResultWatchState
import com.mehdigm.cimastream4.utils.DataStoreHelper.getSubscribedData
import com.mehdigm.cimastream4.utils.DataStoreHelper.getVideoWatchState
import com.mehdigm.cimastream4.utils.DataStoreHelper.getViewPos
import com.mehdigm.cimastream4.utils.DataStoreHelper.removeFavoritesData
import com.mehdigm.cimastream4.utils.DataStoreHelper.removeSubscribedData
import com.mehdigm.cimastream4.utils.DataStoreHelper.setBookmarkedData
import com.mehdigm.cimastream4.utils.DataStoreHelper.setDub
import com.mehdigm.cimastream4.utils.DataStoreHelper.setFavoritesData
import com.mehdigm.cimastream4.utils.DataStoreHelper.setResultEpisode
import com.mehdigm.cimastream4.utils.DataStoreHelper.setResultSeason
import com.mehdigm.cimastream4.utils.DataStoreHelper.setResultWatchState
import com.mehdigm.cimastream4.utils.DataStoreHelper.setSubscribedData
import com.mehdigm.cimastream4.utils.DataStoreHelper.setVideoWatchState
import com.mehdigm.cimastream4.utils.DataStoreHelper.updateSubscribedData
import com.mehdigm.cimastream4.utils.Editor
import com.mehdigm.cimastream4.utils.ExtractorLink
import com.mehdigm.cimastream4.utils.ExtractorLinkType
import com.mehdigm.cimastream4.utils.FillerEpisodeCheck
...
import com.mehdigm.cimastream4.utils.VIDEO_WATCH_STATE
import com.mehdigm.cimastream4.utils.downloader.DownloadFileManagement.sanitizeFilename
...
import com.mehdigm.cimastream4.utils.downloader.DownloadUtils.downloadSubtitle
...
class ResultViewModel2 : ViewModel() {
    ...
    private fun acquireSingleLink(
        ...
        loadLinks(result, isVisible = true, sourceTypes, isCasting = isCasting) { links ->
            ...
            //val context = CimaStreamApp.context
            postPopup(
                text,
