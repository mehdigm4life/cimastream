...
import com.mehdigm.cimastream4.CommonActivity.keyEventListener
...
import com.mehdigm.cimastream4.databinding.SpeedDialogBinding
import com.mehdigm.cimastream4.databinding.SubtitleOffsetBinding
import com.mehdigm.cimastream4.mvvm.logError
import com.mehdigm.cimastream4.ui.player.GeneratorPlayer.Companion.subsProvidersIsActive
...
import com.mehdigm.cimastream4.utils.AppContextUtils.shouldShowPlayerMetadata
...
open class FullScreenPlayer : AbstractPlayerFragment<FragmentPlayerBinding>(
    ...
    private fun handleKeyEvent(event: KeyEvent, hasNavigated: Boolean): Boolean {
        ...
        when (keyCode) {
            ...
            // netflix capture back and hide ~monke
            // This is removed due to inconsistent behavior on A36 vs A22, see https://github.com/mehdigm4life/cimastream/issues/1804
