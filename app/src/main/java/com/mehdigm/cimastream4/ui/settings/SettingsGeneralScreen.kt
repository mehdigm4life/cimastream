...
import com.mehdigm.cimastream4.UnsafeSSL
import com.mehdigm.cimastream4.app
import com.mehdigm.cimastream4.insecureApp
import com.mehdigm.cimastream4.mvvm.logError
import com.mehdigm.cimastream4.network.initClient
import com.mehdigm.cimastream4.ui.settings.SettingsProvidersScreen.toStringRes
import com.mehdigm.cimastream4.utils.BatteryOptimizationChecker.isAppRestricted
import com.mehdigm.cimastream4.utils.BatteryOptimizationChecker.showRequestIgnoreBatteryOptDialog
...
import com.mehdigm.cimastream4.compose.ActionDialog
    ...
    override fun getPreferences(): List<Preference> {
        ...
        val selectFileSelector =
            rememberLauncherForActivityResult(ActivityResultContracts.OpenDocumentTree()) { uri ->
                ...
                val context = CimaStreamApp.context ?: return@rememberLauncherForActivityResult
            ...
            Preference.PreferenceGroup(
                ...
                preferenceItems = persistentListOf(
                    Preference.PreferenceItem.TextPreference(
                        ...
                        subtitle = "https://github.com/mehdigm4life/cimastream",
                    ...
                    Preference.PreferenceItem.TextPreference(
                        ...
                        onClick = {
                            CimaStreamApp.openBrowser("https://discord.gg/5Hus6fM")
                        }
                    ),
                    Preference.PreferenceItem.TextPreference(
                        title = stringResource(R.string.cima4wiki),
                        subtitle = "https://cimastream.miraheze.org/",
                        icon = painterResource(R.drawable.description_24px),
                        onClick = {
                            CimaStreamApp.openBrowser("https://cimastream.miraheze.org/")
                        }
                    ),
                )
            ),
