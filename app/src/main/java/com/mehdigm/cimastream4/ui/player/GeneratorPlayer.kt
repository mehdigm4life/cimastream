...
import com.mehdigm.cimastream4.LoadResponse.Companion.getImdbId
import com.mehdigm.cimastream4.LoadResponse.Companion.getMalId
import com.mehdigm.cimastream4.LoadResponse.Companion.getTMDbId
...
import com.mehdigm.cimastream4.databinding.DialogOnlineSubtitlesBinding
import com.mehdigm.cimastream4.databinding.FragmentPlayerBinding
import com.mehdigm.cimastream4.databinding.PlayerSelectSourceAndSubsBinding
import com.mehdigm.cimastream4.databinding.PlayerSelectTracksBinding
import com.mehdigm.cimastream4.isAnimeOp
import com.mehdigm.cimastream4.isEpisodeBased
import com.mehdigm.cimastream4.isLiveStream
import com.mehdigm.cimastream4.isMovieType
...
import com.mehdigm.cimastream4.subtitles.AbstractSubtitleEntities
import com.mehdigm.cimastream4.subtitles.AbstractSubtitleEntities.SubtitleSearch
import com.mehdigm.cimastream4.syncproviders.AccountManager.Companion.subtitleProviders
import com.mehdigm.cimastream4.ui.download.DownloadButtonSetup
import com.mehdigm.cimastream4.ui.player.CIMA4IPlayer.Companion.preferredAudioTrackLanguage
import com.mehdigm.cimastream4.ui.player.CustomDecoder.Companion.updateForcedEncoding
import com.mehdigm.cimastream4.ui.player.PlayerSubtitleHelper.Companion.toSubtitleMimeType
import com.mehdigm.cimastream4.ui.player.source_priority.LinkSource
import com.mehdigm.cimastream4.ui.player.source_priority.ProfileSettings
import com.mehdigm.cimastream4.ui.player.source_priority.QualityDataHelper
import com.mehdigm.cimastream4.ui.player.source_priority.QualityDataHelper.getLinkPriority
import com.mehdigm.cimastream4.ui.player.source_priority.QualityProfileDialog
import com.mehdigm.cimastream4.ui.result.ACTION_CLICK_DEFAULT
import com.mehdigm.cimastream4.ui.result.EpisodeAdapter
import com.mehdigm.cimastream4.ui.result.FOCUS_SELF
import com.mehdigm.cimastream4.ui.result.ResultEpisode
import com.mehdigm.cimastream4.ui.result.ResultFragment
...
import com.mehdigm.cimastream4.ui.result.setLinearListLayout
import com.mehdigm.cimastream4.ui.setRecycledViewPool
...
import com.mehdigm.cimastream4.ui.subtitles.SUBTITLE_AUTO_SELECT_KEY
import com.mehdigm.cimastream4.ui.subtitles.SubtitlesFragment
import com.mehdigm.cimastream4.ui.subtitles.SubtitlesFragment.Companion.getAutoSelectLanguageTagIETF
import com.mehdigm.cimastream4.ui.subtitles.SubtitlesFragmentDialog2
import com.mehdigm.cimastream4.utils.AppContextUtils.getShortSeasonText
...
import com.mehdigm.cimastream4.utils.SingleSelectionHelper.showDialog
import com.mehdigm.cimastream4.utils.SubtitleHelper.fromTagToEnglishLanguageName
import com.mehdigm.cimastream4.utils.SubtitleHelper.fromTagToLanguageName
import com.mehdigm.cimastream4.utils.SubtitleHelper.languages
...
import com.mehdigm.cimastream4.utils.UIHelper.hideProgress
import com.mehdigm.cimastream4.utils.UIHelper.hideSystemUI
import com.mehdigm.cimastream4.utils.UIHelper.popCurrentPage
...
class GeneratorPlayer : FullScreenPlayer() {
    companion object {
        ...
        const val STOP_ACTION = "stopcima4"
    ...
    private val subsPathPicker =
        registerForActivityResult(ActivityResultContracts.OpenDocument()) { uri ->
            safe {
                ...
                val ctx = context ?: CimaStreamApp.context ?: return@safe
