...
import com.mehdigm.cimastream4.MainActivity.Companion.afterPluginsLoadedEvent
import com.mehdigm.cimastream4.R
import com.mehdigm.cimastream4.Score
import com.mehdigm.cimastream4.SearchResponse
import com.mehdigm.cimastream4.base64Encode
import com.mehdigm.cimastream4.databinding.FragmentResultBinding
import com.mehdigm.cimastream4.databinding.FragmentResultSwipeBinding
import com.mehdigm.cimastream4.databinding.ResultRecommendationsBinding
import com.mehdigm.cimastream4.databinding.ResultSyncBinding
...
import com.mehdigm.cimastream4.ui.download.DOWNLOAD_ACTION_DOWNLOAD
import com.mehdigm.cimastream4.ui.download.DOWNLOAD_ACTION_LONG_CLICK
import com.mehdigm.cimastream4.ui.download.DownloadButtonSetup
import com.mehdigm.cimastream4.ui.player.CIMA4IPlayer
import com.mehdigm.cimastream4.ui.player.CSPlayerEvent
import com.mehdigm.cimastream4.ui.player.IPlayer
import com.mehdigm.cimastream4.ui.player.PlayerView
import com.mehdigm.cimastream4.ui.player.source_priority.QualityProfileDialog
import com.mehdigm.cimastream4.ui.quicksearch.QuickSearchFragment
import com.mehdigm.cimastream4.ui.result.ResultFragment.bindLogo
import com.mehdigm.cimastream4.ui.result.ResultFragment.getStoredData
import com.mehdigm.cimastream4.ui.result.ResultFragment.updateUIEvent
import com.mehdigm.cimastream4.ui.search.SearchAdapter
import com.mehdigm.cimastream4.ui.search.SearchHelper
import com.mehdigm.cimastream4.ui.setRecycledViewPool
import com.mehdigm.cimastream4.ui.settings.SettingsGeneral.Companion.pickDownloadPath
import com.mehdigm.cimastream4.ui.settings.utils.getChooseFolderLauncher
...
import com.mehdigm.cimastream4.utils.AppContextUtils.openBrowser
...
import com.mehdigm.cimastream4.utils.BatteryOptimizationChecker.openBatteryOptimizationSettings
...
import com.mehdigm.cimastream4.utils.SingleSelectionHelper.showBottomDialogInstant
...
import com.mehdigm.cimastream4.utils.UIHelper.populateChips
import com.mehdigm.cimastream4.utils.UIHelper.popupMenuNoIconsAndNoStringRes
import com.mehdigm.cimastream4.utils.UIHelper.setListViewHeightBasedOnItems
...
open class ResultFragmentPhone : BaseFragment<FragmentResultSwipeBinding>(
    ...
    var player: IPlayer = CIMA4IPlayer()
            ...
            resultSubscribe.setOnClickListener {
                viewModel.toggleSubscriptionStatus(context) { newStatus: Boolean? ->
                    ...
                    val name = (viewModel.page.value as? Resource.Success)?.value?.title
                        ?: com.mehdigm.cimastream4.utils.txt(R.string.no_data)
                            .asStringNull(context) ?: ""
                    showToast(
                        com.mehdigm.cimastream4.utils.txt(message, name),
                        Toast.LENGTH_SHORT
                    )
                }
        ...
        observe(viewModel.page) { data ->
            ...
            resultBinding?.apply {
                    ...
                    binding.apply {
                        ...
                        resultShare.setOnClickListener {
                            try {
                                ...
                                val redirectUrl =
                                    "https://mehdigm.github.io/csredirect?redirectto=$encodedUri"
                                i.type = "text/plain"
                ...
                resultTitle.setOnLongClickListener {
                    clipboardHelper(
                        com.mehdigm.cimastream4.utils.txt(R.string.title),
                        resultTitle.text
                    )
                    true
                }
