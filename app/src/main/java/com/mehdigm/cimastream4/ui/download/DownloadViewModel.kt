package com.mehdigm.cimastream4.ui.download
...
import com.mehdigm.cimastream4.services.DownloadQueueService
...
import com.mehdigm.cimastream4.utils.ConsistentLiveData
...
import com.mehdigm.cimastream4.utils.DOWNLOAD_EPISODE_CACHE_BACKUP
...
import com.mehdigm.cimastream4.utils.DataStore.getKeys
import com.mehdigm.cimastream4.utils.DataStore.getSharedPrefs
...
import com.mehdigm.cimastream4.utils.ResourceLiveData
...
import com.mehdigm.cimastream4.utils.downloader.VideoDownloadManager.deleteFilesAndUpdateSettings
import com.mehdigm.cimastream4.utils.downloader.VideoDownloadManager.downloadDeleteEvent
import com.mehdigm.cimastream4.utils.downloader.VideoDownloadManager.getDownloadFileInfo
...
class DownloadViewModel : ViewModel() {
    ...
    private fun onDownloadDeleted(id: Int) {
        ...
        val context = CimaStreamApp.context ?: return
