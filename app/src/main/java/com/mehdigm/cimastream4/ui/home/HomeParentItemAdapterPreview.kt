...
import com.mehdigm.cimastream4.databinding.FragmentHomeHeadBinding
import com.mehdigm.cimastream4.databinding.FragmentHomeHeadTvBinding
...
import com.mehdigm.cimastream4.ui.account.AccountHelper.showAccountEditDialog
...
import com.mehdigm.cimastream4.utils.SingleSelectionHelper.showOptionSelectStringRes
import com.mehdigm.cimastream4.utils.UIHelper.fixPaddingStatusbarMargin
import com.mehdigm.cimastream4.utils.UIHelper.fixPaddingStatusbarView
        ...
        private val resumeAdapter = ResumeItemAdapter(
            ...
            removeCallback = { v ->
                try {
                    ...
                    // Copy pasted from https://github.com/mehdigm4life/cimastream/pull/1658/files
                    builder.apply {
