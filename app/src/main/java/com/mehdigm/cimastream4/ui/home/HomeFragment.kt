...
import com.mehdigm.cimastream4.databinding.HomeEpisodesExpandedBinding
import com.mehdigm.cimastream4.databinding.HomeSelectMainpageBinding
import com.mehdigm.cimastream4.databinding.TvtypesChipsBinding
...
import com.mehdigm.cimastream4.plugins.Plugin
import com.mehdigm.cimastream4.ui.APIRepository.Companion.noneApi
import com.mehdigm.cimastream4.ui.APIRepository.Companion.randomApi
...
import com.mehdigm.cimastream4.ui.account.AccountViewModel
import com.mehdigm.cimastream4.ui.search.SEARCH_ACTION_LOAD
import com.mehdigm.cimastream4.ui.search.SEARCH_ACTION_PLAY_FILE
import com.mehdigm.cimastream4.ui.search.SearchAdapter
import com.mehdigm.cimastream4.ui.search.SearchHelper.handleSearchClickCallback
...
import com.mehdigm.cimastream4.utils.AppContextUtils.filterProviderByPreferredMedia
...
import com.mehdigm.cimastream4.utils.AppContextUtils.isRecyclerScrollable
...
import com.mehdigm.cimastream4.utils.AppContextUtils.ownHide
import com.mehdigm.cimastream4.utils.AppContextUtils.ownShow
import com.mehdigm.cimastream4.utils.AppContextUtils.setDefaultFocus
import com.mehdigm.cimastream4.utils.BackPressedCallbackHelper
...
import com.mehdigm.cimastream4.utils.EmptyEvent
import com.mehdigm.cimastream4.utils.SubtitleHelper.getFlagFromIso
...
import com.mehdigm.cimastream4.utils.UIHelper.getSpanCount
            ...
            binding.apply {
                ...
                when (data) {
                    ...
                    is Resource.Failure -> {
                        ...
                        // Based on https://github.com/mehdigm/cimastream/pull/1438
                        ...
                        // Only hide the open in browser button if we know this is not network shenanigans related to cima4
