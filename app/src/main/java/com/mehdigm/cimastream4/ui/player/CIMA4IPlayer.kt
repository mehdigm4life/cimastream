...
import com.mehdigm.cimastream4.MainActivity.Companion.deleteFileOnExit
...
import com.mehdigm.cimastream4.ui.player.CustomDecoder.Companion.fixSubtitleAlignment
import com.mehdigm.cimastream4.ui.player.live.LiveHelper
import com.mehdigm.cimastream4.ui.player.live.PREFERRED_LIVE_OFFSET
...
import com.mehdigm.cimastream4.ui.subtitles.SaveCaptionStyle
import com.mehdigm.cimastream4.ui.subtitles.SubtitlesFragment.Companion.applyStyle
import com.mehdigm.cimastream4.utils.AppContextUtils.isUsingMobileData
import com.mehdigm.cimastream4.utils.AppContextUtils.setDefaultFocus
import com.mehdigm.cimastream4.utils.CLEARKEY_DRM_UUID
...
import com.mehdigm.cimastream4.utils.DrmExtractorLink
import com.mehdigm.cimastream4.utils.ExtractorLink
import com.mehdigm.cimastream4.utils.ExtractorLinkPlayList
import com.mehdigm.cimastream4.utils.ExtractorLinkType
import com.mehdigm.cimastream4.utils.PLAYREADY_DRM_UUID
import com.mehdigm.cimastream4.utils.SubtitleHelper.fromTagToLanguageName
import com.mehdigm.cimastream4.utils.WIDEVINE_DRM_UUID
...
class CIMA4IPlayer : IPlayer {
    ...
    private fun getCurrentTimestamp(writePosition: Long? = null): VideoSkipStamp? {
        val position = writePosition ?: this@CIMA4IPlayer.getPosition() ?: return null
            ...
            exoPlayer?.apply {
                when (event) {
                    ...
                    CSPlayerEvent.SkipCurrentChapter -> {
                        //val dur = this@CIMA4IPlayer.getDuration() ?: return@apply
