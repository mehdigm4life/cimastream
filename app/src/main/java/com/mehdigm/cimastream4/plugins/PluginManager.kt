...
import com.mehdigm.cimastream4.APIHolder.removePluginMapping
import com.mehdigm.cimastream4.AllLanguagesName
import com.mehdigm.cimastream4.AutoDownloadMode
...
import com.mehdigm.cimastream4.MainAPI.Companion.settingsForProvider
import com.mehdigm.cimastream4.MainActivity.Companion.afterPluginsLoadedEvent
import com.mehdigm.cimastream4.MainActivity.Companion.lastError
import com.mehdigm.cimastream4.PROVIDER_STATUS_DOWN
import com.mehdigm.cimastream4.PROVIDER_STATUS_OK
...
import com.mehdigm.cimastream4.mvvm.debugPrint
import com.mehdigm.cimastream4.mvvm.logError
import com.mehdigm.cimastream4.mvvm.safe
import com.mehdigm.cimastream4.plugins.RepositoryManager.ONLINE_PLUGINS_FOLDER
import com.mehdigm.cimastream4.plugins.RepositoryManager.PREBUILT_REPOSITORIES
import com.mehdigm.cimastream4.plugins.RepositoryManager.downloadPluginToFile
import com.mehdigm.cimastream4.plugins.RepositoryManager.getRepoPlugins
import com.mehdigm.cimastream4.plugins.RepositoryManager.sha256
import com.mehdigm.cimastream4.ui.settings.extensions.REPOSITORIES_KEY
import com.mehdigm.cimastream4.ui.settings.extensions.RepositoryData
...
import com.mehdigm.cimastream4.utils.extractorApis
...
const val EXTENSIONS_CHANNEL_ID = "cimastream4.extensions"
...
object PluginManager {
    ...
    private suspend fun maybeLoadPlugin(context: Context, file: File) {
        val name = file.name
        if (file.extension == "zip" || file.extension == "cima4") {
            loadPlugin(
                context,
                file,
    ...
    fun getPluginPath(
        ...
        return File("${context.filesDir}/${ONLINE_PLUGINS_FOLDER}/${folderName}/$fileName.cima4")
    }
