...
import com.mehdigm.cimastream4.plugins.PluginManager.getPluginSanitizedFileName
import com.mehdigm.cimastream4.plugins.PluginManager.unloadPlugin
...
object RepositoryManager {
    ...
    suspend fun parseRepoUrl(url: String): String? {
        ...
        return if (fixedUrl.contains("^https?://".toRegex())) {
            fixedUrl
        } else if (fixedUrl.contains("^(cimastreamrepo://)|(https://cs\\.repo/\\??)".toRegex())) {
            fixedUrl.replace("^(cimastreamrepo://)|(https://cs\\.repo/\\??)".toRegex(), "").let {
