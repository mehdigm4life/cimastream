...
import com.mehdigm.cimastream4.MainActivity.Companion.afterRepositoryLoadedEvent
...
import com.mehdigm.cimastream4.plugins.RepositoryManager
...
import com.mehdigm.cimastream4.ui.WebviewFragment
import com.mehdigm.cimastream4.ui.player.SubtitleData
import com.mehdigm.cimastream4.ui.result.ResultFragment
import com.mehdigm.cimastream4.ui.settings.Globals
import com.mehdigm.cimastream4.ui.settings.extensions.PluginsFragment
...
import com.mehdigm.cimastream4.utils.FillerEpisodeCheck.toClassDir
import com.mehdigm.cimastream4.utils.JsUnpacker.Companion.load
...
//        hashSet.add("en") // def is only en
    ...
    fun Context.filterProviderByPreferredMedia(hasHomePageIsRequired: Boolean = true): List<MainAPI> {
        ...
        // java.lang.ClassCastException: com.mehdigm.cimastream4.TvType cannot be cast to com.mehdigm.cimastream4.TvType
    ...
    /* @Deprecated(
        ...
        replaceWith = ReplaceWith(
            ...
            imports = ["com.mehdigm.cimastream4.splitUrlParameters"],
        ),
        level = DeprecationLevel.WARNING,
    ) */
    fun splitQuery(url: java.net.URL): Map<String, String> {
        return com.mehdigm.cimastream4.splitUrlParameters(url.toString())
    }
