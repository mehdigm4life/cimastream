...
import com.mehdigm.cimastream4.plugins.PLUGINS_KEY
import com.mehdigm.cimastream4.plugins.PLUGINS_KEY_LOCAL
import com.mehdigm.cimastream4.syncproviders.AccountManager
import com.mehdigm.cimastream4.syncproviders.providers.AniListApi.Companion.ANILIST_CACHED_LIST
import com.mehdigm.cimastream4.syncproviders.providers.MALApi.Companion.MAL_CACHED_LIST
import com.mehdigm.cimastream4.syncproviders.providers.KitsuApi.Companion.KITSU_CACHED_LIST
...
import com.mehdigm.cimastream4.utils.DataStore.getDefaultSharedPrefs
...
import com.mehdigm.cimastream4.utils.downloader.VideoDownloadManager.setupStream
import com.mehdigm.cimastream4.utils.downloader.DownloadObjects
import com.mehdigm.cimastream4.utils.downloader.DownloadQueueManager.QUEUE_KEY
...
object BackupUtils {
    ...
    fun backup(context: Context?) = ioSafe {
        ...
        try {
            ...
            val displayName = "CIMA4_Backup_${date}"
    ...
    /**
     * Copy of [com.mehdigm.cimastream4.utils.downloader.DownloadFileManagement.getDefaultDir],
    ...
    /**
     * Copy of [com.mehdigm.cimastream4.utils.downloader.DownloadFileManagement.getBasePath],
     * modified for backup-specific paths.
     */
    ...
    /**
     * Copy of [com.mehdigm.cimastream4.utils.downloader.DownloadFileManagement.basePathToFile],
     * modified for backup-specific paths.
     */
