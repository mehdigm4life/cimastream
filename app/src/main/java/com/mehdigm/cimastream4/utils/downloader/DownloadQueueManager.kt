...
import com.mehdigm.cimastream4.utils.downloader.VideoDownloadManager.downloadStatus
import com.mehdigm.cimastream4.utils.downloader.VideoDownloadManager.downloadStatusEvent
import com.mehdigm.cimastream4.utils.downloader.VideoDownloadManager.getDownloadFileInfo
import com.mehdigm.cimastream4.utils.downloader.VideoDownloadManager.getDownloadQueuePackage
import com.mehdigm.cimastream4.utils.downloader.VideoDownloadManager.getDownloadResumePackage
...
object DownloadQueueManager {
     ...
     * @see com.mehdigm.cimastream4.services.DownloadQueueService.Companion.downloadInstances
     */
    ...
    fun addToQueue(downloadQueueWrapper: DownloadQueueWrapper) = safe {
        val context = CimaStreamApp.context ?: return@safe
