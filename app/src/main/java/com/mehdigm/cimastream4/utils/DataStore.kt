...
object DataStore {
    ...
    @Deprecated(
        "Please do not use the mapper version from DataStore. Preferably use methods from AppUtils " +
            ...
            "com.mehdigm.cimastream4.mapper to access the mapper directly if necessary.",
        level = DeprecationLevel.ERROR,
        replaceWith = ReplaceWith("com.mehdigm.cimastream4.mapper"),
    )
    val mapper = com.mehdigm.cimastream4.mapper
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith(
            ...
            imports = ["com.mehdigm.cimastream4.utils.AppUtils.parseJson"],
        ),
    )
